...
pub fn canonical_liquid_watch_targets() -> Vec<obschain_core::WatchTarget> {
    let case_uuid = Uuid::parse_str(LIQUID_INCIDENT_UUID).expect("Valid static UUID");
    let mut t1 = obschain_core::WatchTarget::new_outpoint(
        case_uuid,
        LIQUID_CASE_ID,
    ...
    t1.id = Uuid::parse_str("0c202600-0001-0001-0000-000000000001").expect("Valid static UUID");

    let mut t2 = obschain_core::WatchTarget::new_outpoint(
        case_uuid,
        LIQUID_CASE_ID,
    ...
    t2.id = Uuid::parse_str("0c202600-0001-0001-0000-000000000002").expect("Valid static UUID");

    let mut t3 = obschain_core::WatchTarget::new_outpoint(
        case_uuid,
        LIQUID_CASE_ID,
        "a6d697a25266ce3c78774fd1d75f896b7af522ada209b0f6228ea497bc49a46d",
        1,
    ...
    t3.id = Uuid::parse_str("0c202600-0001-0001-0000-000000000003").expect("Valid static UUID");

    let mut t4 = obschain_core::WatchTarget::new_transaction(
        case_uuid,
        LIQUID_CASE_ID,
    ...
    t4.id = Uuid::parse_str("0c202600-0001-0001-0000-000000000004").expect("Valid static UUID");

    let mut t5 = obschain_core::WatchTarget::new_address(
        case_uuid,
        LIQUID_CASE_ID,
    ...
    t5.id = Uuid::parse_str("0c202600-0001-0001-0000-000000000005").expect("Valid static UUID");

    let mut t6 = obschain_core::WatchTarget::new_address(
        case_uuid,
        LIQUID_CASE_ID,
    ...
    t6.id = Uuid::parse_str("0c202600-0001-0001-0000-000000000006").expect("Valid static UUID");
